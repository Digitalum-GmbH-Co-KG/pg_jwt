...
#define CONFIGURE_ARGS " '--host=x86_64-suse-linux' '--build=x86_64-suse-linux' '--program-prefix=' '--disable-dependency-tracking' '--prefix=/usr' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--sysconfdir=/etc' '--datadir=/usr/share' '--includedir=/usr/include' '--libdir=/usr/lib64' '--libexecdir=/usr/libexec' '--localstatedir=/var' '--sharedstatedir=/var/lib' '--infodir=/usr/share/info' '--bindir=/usr/lib/postgresql18/bin' '--libdir=/usr/lib/postgresql18/lib64' '--includedir=/usr/include/pgsql' '--datadir=/usr/share/postgresql18' '--docdir=/usr/share/doc/packages/postgresql18' '--mandir=/usr/share/man' '--disable-rpath' '--enable-nls' '--enable-thread-safety' '--enable-integer-datetimes' '--with-python' '--with-perl' '--with-tcl' '--with-tclconfig=/usr/lib64' '--with-pam' '--with-uuid=e2fs' '--with-libxml' '--with-libxslt' '--with-libcurl' '--with-liburing' '--with-libnuma' '--with-lz4' '--with-zstd' '--with-systemd' '--with-selinux' '--with-icu' '--with-llvm' '--with-openssl' '--with-ldap' '--with-gssapi' '--with-krb5' '--with-system-tzdata=/usr/share/zoneinfo' 'build_alias=x86_64-suse-linux' 'host_alias=x86_64-suse-linux' 'CFLAGS=-O2 -Wall -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=3 -fstack-protector-strong -funwind-tables -fasynchronous-unwind-tables -fstack-clash-protection -Werror=return-type -flto=auto -ffat-lto-objects -g' 'LDFLAGS=-flto=auto -ffat-lto-objects' 'CXXFLAGS=-O2 -Wall -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=3 -fstack-protector-strong -funwind-tables -fasynchronous-unwind-tables -fstack-clash-protection -Werror=return-type -flto=auto -ffat-lto-objects -g' 'PKG_CONFIG_PATH=:/usr/lib64/pkgconfig:/usr/share/pkgconfig' 'PYTHON=python3'"
...
#define PG_VERSION_STR "PostgreSQL 18.2 on x86_64-suse-linux-gnu, compiled by gcc (SUSE Linux) 13.4.0, 64-bit"
